"""
Django settings for currantDjango project.
...
SECRET_KEY = os.environ.get("SECRET_KEY", 'django-insecure-m3onw4)r=bowo6*ku%!@7%w(m04dfg$_^d)r+bls9=)@xbi3ti')
...
ROOT_URLCONF = 'currantDjango.urls'
...
WSGI_APPLICATION = 'currantDjango.wsgi.application'
...
CORS_ORIGIN_WHITELIST = (
    'http://localhost:4200',
    'http://currant.proteo.info',
    'http://10.201.84.175:4200',
)
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('POSTGRES_NAME', 'currant'),
...
RQ_QUEUES = {
    'default': {
        ...
        'PASSWORD': os.environ.get('REDIS_PASSWORD', 'testredis'),
    }
}
...
CHANNEL_LAYERS = {
    "default": {
        ...
        "CONFIG": {
            "hosts": [
                f"redis://:{os.environ.get('REDIS_PASSWORD', 'testredis')}@{os.environ.get('REDIS_HOST', 'localhost')}:{os.environ.get('REDIS_PORT', '6379')}/0"],
